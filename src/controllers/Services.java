...
//	@FXML private TableColumn<CheckOut, LocalDate> paidDateCol;
	...
	@FXML private TextField firstName2;
	...
	public void addMember() throws IOException,NullPointerException{
	    ...
	    if(matcher.matches()){
			...
			if(ad.isSelected()){
				...
				if(admin.addNewMember(firstName.getText(), lastName.getText(), address, lastName2.getText(), firstName2.getText(),Role.ADMIN)){

						Administrator adds = new Administrator(firstName.getText(), lastName.getText(), address, lastName2.getText(), firstName2.getText(),Role.ADMIN);
						DataAccessFacade.saveStaff(adds);

						System.out.println(firstName.getText() + lastName.getText() + lastName2.getText() +  firstName2.getText());
			...
			if(lib.isSelected()){
				if(admin.addNewMember(firstName.getText(), lastName.getText(), address, lastName2.getText(), firstName2.getText(),Role.LIBRARIAN)){
			...
			if(lib.isSelected() && ad.isSelected()){
				if(admin.addNewMember(firstName.getText(), lastName.getText(), address, lastName2.getText(), firstName2.getText(),Role.BOTH)){
